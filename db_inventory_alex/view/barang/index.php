...
<div class="container">
    ...
    <a href="view_tambah.php" class="btn btn-primary"><i class="fa-solid fa-circle-plus"></i>Tambah Barang Baru</a>
    <br></br>
  ...
  if(mysqli_num_rows($query)){
    ...
    <tr>
      ...
      <a href="view_edit.php?id_barang=<?php echo $result['id_barang']?>"
        class="btn btn-primary"><i class="fa-solid fa-pen-fancy"></i>Edit</a>
